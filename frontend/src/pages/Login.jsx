...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      // if (formData.email === 'error@tripify.com') {
      //   setError('Invalid email or password.');
      // } else {
      //   // Mock token generation
      //   const mockJwt = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.MockPayload.MockSignature_123';
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 font-sans">
      ...
      <div 
        ...
        style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?q=80&w=1600&auto=format&fit=crop)' }}
      >
        <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/20 to-transparent"></div>
        <div className="absolute bottom-12 left-12 right-12 text-white">
          <h2 className="text-4xl font-bold mb-4">Discover the world's most amazing destinations.</h2>
          <p className="text-lg text-slate-200">Join thousands of travelers who use Tripify to plan their perfect itinerary.</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col px-8 py-10 md:px-16 lg:px-24 justify-between">
        ...
        <div className="flex-grow flex flex-col justify-center max-w-md w-full mx-auto my-12">
          ...
          <p className="text-slate-500 mb-8">Sign in to your account and continue planning your next adventure.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button 
              type="submit" 
              className="w-full py-3.5 px-4 bg-primary-dark hover:bg-indigo-600 text-white rounded-xl font-bold shadow-md hover:shadow-lg transition-all"
            >
              Sign In
            </button>
          </form>
          ...
          <p className="mt-8 text-center text-slate-500">
            Don't have an account? <Link to="/register" className="font-semibold text-primary-dark hover:text-indigo-600">Sign Up</Link>
          </p>
        </div>
